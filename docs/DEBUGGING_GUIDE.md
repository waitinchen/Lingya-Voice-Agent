...
| 问题 | 症状 | 解决方案 | 状态 |
|------|------|----------|------|
| abortSignal 错误 | 400 错误 | 已修复（使用 `signal`） | ✅ |
| undefined 消息 | 聊天显示 "undefined" | 已添加数据验证 | ✅ |
| 录音无响应 | 点击录音按钮无反应 | 检查权限和 WebSocket | ⚠️ |
| 语音识别超时 | 30秒超时错误 | 检查音频大小和网络 | ⚠️ |
| TTS 超时 | 45秒超时错误 | 检查文本长度和 API | ⚠️ |

---

当遇到 "undefined" 或其他错误时，可以通過以下方式查看問題：
